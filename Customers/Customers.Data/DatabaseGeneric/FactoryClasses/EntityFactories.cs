...
namespace Customers.Data.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, Customers.Data.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((Customers.Data.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CustomerEntityFactory() : base("CustomerEntity", Customers.Data.EntityType.CustomerEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public OrderEntityFactory() : base("OrderEntity", Customers.Data.EntityType.OrderEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(Customers.Data.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(Customers.Data.EntityType)))
			{
				var factory = GetFactory((Customers.Data.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Customers.Data.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Customers.Data.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case Customers.Data.EntityType.CustomerEntity:
					return new CustomerEntityFactory();
				case Customers.Data.EntityType.OrderEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the Customers.Data.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Customers.Data.EntityType)Enum.Parse(typeof(Customers.Data.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((Customers.Data.EntityType)Enum.Parse(typeof(Customers.Data.EntityType), leftOperandEntityName, false), joinType, (Customers.Data.EntityType)Enum.Parse(typeof(Customers.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (Customers.Data.EntityType)Enum.Parse(typeof(Customers.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((Customers.Data.EntityType)entityTypeValue); }
